              ...
              <div class="">
                <section class="col-md-4 col-sm-12"> 
                  ...
                  <div class="payment-container">
                   ...
                   <div style="border: solid #d4cdcd 1px; border-radius: 50px; margin-bottom: 6px;">
                    ...
                    <div style="border: solid #d4cdcd 1px; border-radius: 50px; margin-bottom: 6px;">
                      <img src="http://localhost/opencart/image/banks/ub.png" style="border-radius:  21px 0px 0px 21px">
                ...
                <section class="col-md-4 col-sm-12"> 
                  ...
                  <div class="payment-container"> 
                    ...
                    <div style="border: solid #d4cdcd 1px; border-radius: 50px; margin-bottom: 6px;">
                      <img src="http://localhost/opencart/image/banks/GrabPay.png" style="border-radius:  21px 0px 0px 21px">
