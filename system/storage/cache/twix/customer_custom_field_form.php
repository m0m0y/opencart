...
/* Twix ver. 1.18  Source: C:\xampp\htdocs\opencart\admin\view\template\customer\custom_field_form.twig */
class customer_custom_field_form extends Twix_Template
{
...
?>              <div class="input-group"><span class="input-group-addon"><img src="language/<?php echo @$language["code"] ?>/<?php echo @$language["code"] ?>.png" title="<?php echo @$language["name"] ?>" /></span>
                <input type="text" name="custom_field_description[<?php echo @$language["language_id"] ?>][name]" value="<?php echo ((@$custom_field_description[@$language["language_id"]]) ? (@$custom_field_description[@$language["language_id"]]["name"]) : ("")) ?>" placeholder="<?php echo @$entry_name ?>" class="form-control" />
              </div>
              <?php
...
?>                </optgroup>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10"><?php
        $customer_group_row = 0 ?>              <?php
        @$save50575 = $customer_group        ;
        $context['_parent'] = $context;
        $context['_seq'] = twix_ensure_traversable(@$customer_groups);
        foreach ($context['_seq'] as $_key => $customer_group) {
?>              <div class="checkbox">
                <label> <?php
            if (twix_in_filter(@$customer_group["customer_group_id"], @$custom_field_customer_group)) {
...
?> </label>
              ...
              <?php
            $customer_group_row = (@$customer_group_row + 1) ?>              <?php
        }
        $_parent = $context['_parent'];
        unset($context['_seq'], $context['_iterated'], $context['_key'], $context['customer_group'], $context['_parent'], $context['loop']);
        $context = array_intersect_key($context, $_parent) + $_parent;
$customer_group         = $save50575 ?></div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label"><?php echo @$entry_required ?></label>
            <div class="col-sm-10"><?php
        $customer_group_row = 0 ?>              <?php
        @$save88341 = $customer_group        ;
        $context['_parent'] = $context;
        $context['_seq'] = twix_ensure_traversable(@$customer_groups);
        foreach ($context['_seq'] as $_key => $customer_group) {
?>              <div class="checkbox">
                <label> <?php
            if (twix_in_filter(@$customer_group["customer_group_id"], @$custom_field_required)) {
          ...
          <div id="custom-field-value">
            <fieldset>
              ...
              <table class="table table-striped table-bordered table-hover">
                ...
                <?php
        $custom_field_value_row = 0 ?>                <?php
        @$save30650 = $custom_field_value        ;
        $context['_parent'] = $context;
        $context['_seq'] = twix_ensure_traversable(@$custom_field_values);
...
?>                <tr id="custom-field-value-row<?php echo @$custom_field_value_row ?>">
            ...
            foreach ($context['_seq'] as $_key => $language) {
?>                    <div class="input-group"> <span class="input-group-addon"><img src="language/<?php echo @$language["code"] ?>/<?php echo @$language["code"] ?>.png" title="<?php echo @$language["name"] ?>" /></span>
                      <input type="text" name="custom_field_value[<?php echo @$custom_field_value_row ?>][custom_field_value_description][<?php echo @$language["language_id"] ?>][name]" value="<?php echo ((@$custom_field_value["custom_field_value_description"][@$language["language_id"]]) ? (@$custom_field_value["custom_field_value_description"][@$language["language_id"]]["name"]) : ("")) ?>" placeholder="<?php echo @$entry_custom_value ?>" class="form-control" />
                    </div>
                    <?php
...
$language             = $save13166 ?></td>
                ...
                <?php
            $custom_field_value_row = (@$custom_field_value_row + 1) ?>                <?php
        }
        $_parent = $context['_parent'];
        unset($context['_seq'], $context['_iterated'], $context['_key'], $context['custom_field_value'], $context['_parent'], $context['loop']);
        $context = array_intersect_key($context, $_parent) + $_parent;
$custom_field_value         = $save30650 ?>                  </tbody>
