...
?>              <?php
        ...
        $context = array_intersect_key($context, $_parent) + $_parent;
$category         = $save76500 ?>              <ul class="dropdown-menu">
                <?php
        @$save80013 = $category        ;
        $context['_parent'] = $context;
        $context['_seq'] = twix_ensure_traversable(@$categories);
