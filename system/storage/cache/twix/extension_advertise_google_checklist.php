...
/* Twix ver. 1.18  Source: C:\xampp\htdocs\opencart\admin\view\template\extension\advertise\google_checklist.twig */
class extension_advertise_google_checklist extends Twix_Template
{
    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                <a href="<?php echo @$text_video_tutorial_url_install ?>" target="_blank" class="btn btn-info" data-toggle="tooltip" title="<?php echo @$button_video_tutorial_install ?>"><i class="fa fa-video-camera"></i></a>
