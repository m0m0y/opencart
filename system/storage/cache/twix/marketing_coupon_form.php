...
/* Twix ver. 1.18  Source: C:\xampp\htdocs\opencart\admin\view\template\marketing\coupon_form.twig */
class marketing_coupon_form extends Twix_Template
{
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input type="text" name="name" value="<?php echo @$name ?>" placeholder="<?php echo @$entry_name ?> / Refferral Name" id="input-name" class="form-control" />
                  <?php
        if (@$error_name) {
...
?>                  
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-type"><span data-toggle="tooltip" title="<?php echo @$help_type ?>">Discount Type</span></label>
                <div class="col-sm-10">
                  <select name="discount_type" id="input-type" class="form-control">
                    <?php
        if ((@$discount_type == "")) {
?>                    
                    <option value="" selected="selected">Coupon</option>
...
?>            <div class="tab-pane" id="tab-history">
              <fieldset>
                <legend><?php echo @$text_coupon ?></legend>
                <div id="history"></div>
              </fieldset>
            </div>
            <?php
...
$('#history').load('index.php?route=marketing/coupon/history&user_token=<?php echo @$user_token ?>&coupon_id=<?php echo @$coupon_id ?>');
//--></script> 
  <?php
        }
?> 
