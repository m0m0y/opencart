...
/* Twix ver. 1.18  Source: C:\xampp\htdocs\opencart\admin\view\template\catalog\option_form.twig */
class catalog_option_form extends Twix_Template
{
...
?>                <div class="input-group"><span class="input-group-addon"><img src="language/<?php echo @$language["code"] ?>/<?php echo @$language["code"] ?>.png" title="<?php echo @$language["name"] ?>" /></span>
                  <input type="text" name="option_description[<?php echo @$language["language_id"] ?>][name]" value="<?php echo ((@$option_description[@$language["language_id"]]) ? (@$option_description[@$language["language_id"]]["name"]) : ("")) ?>" placeholder="<?php echo @$entry_name ?>" class="form-control" />
                </div>
                <?php
...
$language             = $save96209 ?></td>
        ...
        $context = array_intersect_key($context, $_parent) + $_parent;
$option_value         = $save12732 ?>                </tbody>
              
              <tfoot>
                <tr>
                  <td colspan="3"></td>
                  <td class="text-right"><button type="button" onclick="addOptionValue();" data-toggle="tooltip" title="<?php echo @$button_option_value_add ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i></button></td>
                </tr>
              </tfoot>
            </table>
          </fieldset>
