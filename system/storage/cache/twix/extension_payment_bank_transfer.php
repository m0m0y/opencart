...
/* Twix ver. 1.18  Source: C:\xampp\htdocs\opencart\admin\view\template\extension\payment\bank_transfer.twig */
class extension_payment_bank_transfer extends Twix_Template
{
...
?>          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <div class="input-group"><span class="input-group-addon"><img src="language/<?php echo @$language["code"] ?>/<?php echo @$language["code"] ?>.png" title="<?php echo @$language["name"] ?>" /></span>
                <textarea name="payment_bank_transfer_bank<?php echo @$language["language_id"] ?>" cols="80" rows="10" placeholder="<?php echo @$entry_bank ?>" id="input-bank<?php echo @$language["language_id"] ?>" class="form-control"><?php
            if (@$payment_bank_transfer_bank[@$language["language_id"]]) {
echo @$payment_bank_transfer_bank[@$language["language_id"]];
            }
?></textarea>
              </div>
              <?php
...
?>            </div>
        ...
        $context = array_intersect_key($context, $_parent) + $_parent;
$language         = $save81732 ?>          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-total"><span data-toggle="tooltip" title="<?php echo @$help_total ?>"><?php echo @$entry_total ?></span></label>
            <div class="col-sm-10">
              <input type="text" name="payment_bank_transfer_total" value="<?php echo @$payment_bank_transfer_total ?>" placeholder="<?php echo @$entry_total ?>" id="input-total" class="form-control" />
            </div>
          </div>
...
?>              </select>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="payment_bank_transfer_sort_order" value="<?php echo @$payment_bank_transfer_sort_order ?>" placeholder="<?php echo @$entry_sort_order ?>" id="input-sort-order" class="form-control" />
            </div>
          </div>
        </form>
      </div>
