...
/* Twix ver. 1.18  Source: C:\xampp\htdocs\opencart\admin\view\template\tool\backup.twig */
class tool_backup extends Twix_Template
{
...
?>    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        @$save16518 = $table        ;
        $context['_parent'] = $context;
        $context['_seq'] = twix_ensure_traversable(@$tables);
        foreach ($context['_seq'] as $_key => $table) {
?>                    <div class="checkbox">
                      <label>
...
$('#button-import').on('click', function() {
	...
	timer = setInterval(function() {
		if ($('#form-upload input[name=\'import\']').val() != '') {
			...
			$.ajax({
				url: 'index.php?route=tool/backup/import&user_token=<?php echo @$user_token ?>',
				type: 'post',
				dataType: 'json',
