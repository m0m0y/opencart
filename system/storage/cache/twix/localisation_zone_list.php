...
/* Twix ver. 1.18  Source: C:\xampp\htdocs\opencart\admin\view\template\localisation\zone_list.twig */
class localisation_zone_list extends Twix_Template
{
...
?>                <?php
            @$save27410 = $zone            ;
            $context['_parent'] = $context;
            $context['_seq'] = twix_ensure_traversable(@$zones);
            foreach ($context['_seq'] as $_key => $zone) {
?>                <tr>
                  <td class="text-center"><?php
                if (twix_in_filter(@$zone["zone_id"], @$selected)) {
