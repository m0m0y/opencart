...
/* Twix ver. 1.18  Source: C:\xampp\htdocs\opencart\admin\view\template\extension\dashboard\map_info.twig */
class extension_dashboard_map_info extends Twix_Template
{
...
$(document).ready(function() {
	$.ajax({
		url: 'index.php?route=extension/dashboard/map/map&user_token=<?php echo @$user_token ?>',
		dataType: 'json',
