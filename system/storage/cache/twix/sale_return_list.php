...
/* Twix ver. 1.18  Source: C:\xampp\htdocs\opencart\admin\view\template\sale\return_list.twig */
class sale_return_list extends Twix_Template
{
  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="button" data-toggle="tooltip" title="<?php echo @$button_filter ?>" onclick="$('#filter-return').toggleClass('hidden-sm hidden-xs');" class="btn btn-default hidden-md hidden-lg"><i class="fa fa-filter"></i></button>
...
$return_status         = $save60914 ?>                
      ...
      <div class="col-md-9 col-md-pull-3 col-sm-12">
        ...
        if ((@$sort == "r.return_id")) {
?> <a href="<?php echo @$sort_return_id ?>" class="<?php echo strtolower(@$order) ?>"><?php echo @$column_return_id ?></a> <?php
        } else {
?> <a href="<?php echo @$sort_return_id ?>"><?php echo @$column_return_id ?></a> <?php
        }
?></td>
                      <td class="text-right"><?php
        if ((@$sort == "r.order_id")) {
?> <a href="<?php echo @$sort_order_id ?>" class="<?php echo strtolower(@$order) ?>"><?php echo @$column_order_id ?></a> <?php
        } else {
...
?>                  <tr>
                ...
                if (twix_in_filter(@$return["return_id"], @$selected)) {
...
?></td>
                    ...
                    <td class="text-left"><?php echo @$return["return_status"] ?></td>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=sale/return&user_token=<?php echo @$user_token ?>';
