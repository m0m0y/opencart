...
/* Twix ver. 1.18  Source: C:\xampp\htdocs\opencart\admin\view\template\sale\order_form.twig */
class sale_order_form extends Twix_Template
{
...
?>                    <?php
        ...
        $context = array_intersect_key($context, $_parent) + $_parent;
$customer_group         = $save62985 ?>                  </select>
                </div>
              </div>
...
?>                    <?php
                    ...
                    $context = array_intersect_key($context, $_parent) + $_parent;
$custom_field_value                     = $save27809 ?>                  </select>
                </div>
              </div>
              <?php
                }
...
?>                    </div>
                    ...
                    unset($context['_seq'], $context['_iterated'], $context['_key'], $context['custom_field_value'], $context['_parent'], $context['loop']);
                    $context = array_intersect_key($context, $_parent) + $_parent;
$custom_field_value                     = $save20668 ?>                  </div>
                </div>
              </div>
              <?php
                }
...
?>                    </div>
                    ...
                    unset($context['_seq'], $context['_iterated'], $context['_key'], $context['custom_field_value'], $context['_parent'], $context['loop']);
                    $context = array_intersect_key($context, $_parent) + $_parent;
$custom_field_value                     = $save88903 ?>                  </div>
                </div>
              </div>
              <?php
                }
...
?>              <?php
        ...
        $context = array_intersect_key($context, $_parent) + $_parent;
$custom_field         = $save87161 ?>              <div class="text-right">
            ...
            <div class="tab-pane" id="tab-cart">
              <div class="table-responsive">
                <table class="table table-bordered">
                  ...
                  <tbody id="cart">
                    <?php
        if ((@$order_products || @$order_vouchers)) {
?>                    <?php
            $product_row = 0 ?>                    <?php
            @$save15824 = $order_product            ;
            $context['_parent'] = $context;
            $context['_seq'] = twix_ensure_traversable(@$order_products);
            foreach ($context['_seq'] as $_key => $order_product) {
?>                    <tr>
                ...
                @$save13983 = $option                ;
                $context['_parent'] = $context;
                $context['_seq'] = twix_ensure_traversable(@$order_product["option"]);
...
$option                 = $save13983 ?></td>
                    ...
                    <?php
                $product_row = (@$product_row + 1) ?>                    <?php
            }
            $_parent = $context['_parent'];
            unset($context['_seq'], $context['_iterated'], $context['_key'], $context['order_product'], $context['_parent'], $context['loop']);
            $context = array_intersect_key($context, $_parent) + $_parent;
$order_product             = $save15824 ?>                    <?php
            $voucher_row = 0 ?>                    <?php
            @$save39882 = $order_voucher            ;
            $context['_parent'] = $context;
            $context['_seq'] = twix_ensure_traversable(@$order_vouchers);
            foreach ($context['_seq'] as $_key => $order_voucher) {
?>                    <tr>
                    ...
                    <div class="form-group required">
                      ...
                      <div class="col-sm-10">
                        <select name="voucher_theme_id" id="input-theme" class="form-control">
                          <?php
        @$save19350 = $voucher_theme        ;
        $context['_parent'] = $context;
        $context['_seq'] = twix_ensure_traversable(@$voucher_themes);
        foreach ($context['_seq'] as $_key => $voucher_theme) {
?>                          <option value="<?php echo @$voucher_theme["voucher_theme_id"] ?>"><?php echo @$voucher_theme["name"] ?></option>
        ...
        $context = array_intersect_key($context, $_parent) + $_parent;
$voucher_theme         = $save19350 ?>                        </select>
                      </div>
                    </div>
                    <div class="form-group">
...
?>              <div class="form-group custom-field custom-field<?php echo @$custom_field["custom_field_id"] ?>" data-sort="<?php echo (@$custom_field["sort_order"] + 3) ?>">
                ...
                <div class="col-sm-10">
                  <select name="custom_field[<?php echo @$custom_field["custom_field_id"] ?>]" id="input-payment-custom-field<?php echo @$custom_field["custom_field_id"] ?>" class="form-control">
                    <option value=""><?php echo @$text_select ?></option>
                    <?php
                    @$save53214 = $custom_field_value                    ;
                    $context['_parent'] = $context;
                    $context['_seq'] = twix_ensure_traversable(@$custom_field["custom_field_value"]);
                    foreach ($context['_seq'] as $_key => $custom_field_value) {
?>                    <?php
                        if ((@$payment_custom_field[@$custom_field["custom_field_id"]] && (@$custom_field_value["custom_field_value_id"] == @$payment_custom_field[@$custom_field["custom_field_id"]]))) {
?>                    <option value="<?php echo @$custom_field_value["custom_field_value_id"] ?>" selected="selected"><?php echo @$custom_field_value["name"] ?></option>
                    <?php
                        } else {
?>                    <option value="<?php echo @$custom_field_value["custom_field_value_id"] ?>"><?php echo @$custom_field_value["name"] ?></option>
...
?>                    <?php
                    ...
                    unset($context['_seq'], $context['_iterated'], $context['_key'], $context['custom_field_value'], $context['_parent'], $context['loop']);
                    $context = array_intersect_key($context, $_parent) + $_parent;
$custom_field_value                     = $save53214 ?>                  </select>
                </div>
              </div>
              <?php
                }
...
?>                    </div>
                    ...
                    unset($context['_seq'], $context['_iterated'], $context['_key'], $context['custom_field_value'], $context['_parent'], $context['loop']);
                    $context = array_intersect_key($context, $_parent) + $_parent;
$custom_field_value                     = $save33172 ?>                  </div>
                </div>
              </div>
              <?php
                }
...
?>              <div class="form-group custom-field custom-field<?php echo @$custom_field["custom_field_id"] ?>" data-sort="<?php echo (@$custom_field["sort_order"] + 3) ?>">
                ...
                <div class="col-sm-10">
                  <div id="input-payment-custom-field<?php echo @$custom_field["custom_field_id"] ?>">
                    <?php
                    @$save70122 = $custom_field_value                    ;
                    $context['_parent'] = $context;
                    $context['_seq'] = twix_ensure_traversable(@$custom_field["custom_field_value"]);
                    foreach ($context['_seq'] as $_key => $custom_field_value) {
?>                    <div class="checkbox">
                      <?php
                        if ((@$payment_custom_field[@$custom_field["custom_field_id"]] && twix_in_filter(@$custom_field_value["custom_field_value_id"], @$payment_custom_field[@$custom_field["custom_field_id"]]))) {
?>                      <label>
                        <input type="checkbox" name="custom_field[<?php echo @$custom_field["custom_field_id"] ?>][]" value="<?php echo @$custom_field_value["custom_field_value_id"] ?>" checked="checked" />
                        <?php echo @$custom_field_value["name"] ?></label>
                      <?php
...
?>                    </div>
                    ...
                    unset($context['_seq'], $context['_iterated'], $context['_key'], $context['custom_field_value'], $context['_parent'], $context['loop']);
                    $context = array_intersect_key($context, $_parent) + $_parent;
$custom_field_value                     = $save70122 ?>                  </div>
                </div>
              </div>
              <?php
                }
...
?>              <div class="form-group custom-field custom-field<?php echo @$custom_field["custom_field_id"] ?>" data-sort="<?php echo (@$custom_field["sort_order"] + 3) ?>">
                <label class="col-sm-2 control-label" for="input-payment-custom-field<?php echo @$custom_field["custom_field_id"] ?>"><?php echo @$custom_field["name"] ?></label>
                <div class="col-sm-10">
                  <input type="text" name="custom_field[<?php echo @$custom_field["custom_field_id"] ?>]" value="<?php echo ((@$payment_custom_field[@$custom_field["custom_field_id"]]) ? (@$payment_custom_field[@$custom_field["custom_field_id"]]) : (@$custom_field["value"])) ?>" placeholder="<?php echo @$custom_field["name"] ?>" id="input-payment-custom-field<?php echo @$custom_field["custom_field_id"] ?>" class="form-control" />
                </div>
              </div>
              <?php
                }
...
?>              <div class="form-group custom-field custom-field<?php echo @$custom_field["custom_field_id"] ?>" data-sort="<?php echo (@$custom_field["sort_order"] + 3) ?>">
                <label class="col-sm-2 control-label" for="input-payment-custom-field<?php echo @$custom_field["custom_field_id"] ?>"><?php echo @$custom_field["name"] ?></label>
                <div class="col-sm-10">
                  <textarea name="custom_field[<?php echo @$custom_field["custom_field_id"] ?>]" rows="5" placeholder="<?php echo @$custom_field["name"] ?>" id="input-payment-custom-field<?php echo @$custom_field["custom_field_id"] ?>" class="form-control"><?php echo ((@$payment_custom_field[@$custom_field["custom_field_id"]]) ? (@$payment_custom_field[@$custom_field["custom_field_id"]]) : (@$custom_field["value"])) ?></textarea>
                </div>
              </div>
              <?php
                }
...
?>              <div class="form-group custom-field custom-field<?php echo @$custom_field["custom_field_id"] ?>" data-sort="<?php echo (@$custom_field["sort_order"] + 3) ?>">
                ...
                <div class="col-sm-10">
                  ...
                  <input type="hidden" name="custom_field[<?php echo @$custom_field["custom_field_id"] ?>]" value="<?php echo ((@$payment_custom_field[@$custom_field["custom_field_id"]]) ? (@$payment_custom_field[@$custom_field["custom_field_id"]]) : ("")) ?>" id="input-payment-custom-field<?php echo @$custom_field["custom_field_id"] ?>" />
                </div>
              </div>
              <?php
                }
...
?>              <?php
        ...
        unset($context['_seq'], $context['_iterated'], $context['_key'], $context['custom_field'], $context['_parent'], $context['loop']);
        $context = array_intersect_key($context, $_parent) + $_parent;
$custom_field         = $save28727 ?>              <div class="row">
                <div class="col-sm-6 text-left">
...
?>              <div class="form-group custom-field custom-field<?php echo @$custom_field["custom_field_id"] ?>" data-sort="<?php echo (@$custom_field["sort_order"] + 3) ?>">
                ...
                <div class="col-sm-10">
                  <select name="custom_field[<?php echo @$custom_field["custom_field_id"] ?>]" id="input-shipping-custom-field<?php echo @$custom_field["custom_field_id"] ?>" class="form-control">
                    <option value=""><?php echo @$text_select ?></option>
                    <?php
                    @$save67523 = $custom_field_value                    ;
                    $context['_parent'] = $context;
                    $context['_seq'] = twix_ensure_traversable(@$custom_field["custom_field_value"]);
                    foreach ($context['_seq'] as $_key => $custom_field_value) {
?>                    <?php
                        if ((@$shipping_custom_field[@$custom_field["custom_field_id"]] && (@$custom_field_value["custom_field_value_id"] == @$shipping_custom_field[@$custom_field["custom_field_id"]]))) {
?>                    <option value="<?php echo @$custom_field_value["custom_field_value_id"] ?>" selected="selected"><?php echo @$custom_field_value["name"] ?></option>
                    <?php
                        } else {
?>                    <option value="<?php echo @$custom_field_value["custom_field_value_id"] ?>"><?php echo @$custom_field_value["name"] ?></option>
...
?>                    <?php
                    ...
                    unset($context['_seq'], $context['_iterated'], $context['_key'], $context['custom_field_value'], $context['_parent'], $context['loop']);
                    $context = array_intersect_key($context, $_parent) + $_parent;
$custom_field_value                     = $save67523 ?>                  </select>
                </div>
              </div>
              <?php
                }
...
?>                    </div>
                    ...
                    unset($context['_seq'], $context['_iterated'], $context['_key'], $context['custom_field_value'], $context['_parent'], $context['loop']);
                    $context = array_intersect_key($context, $_parent) + $_parent;
$custom_field_value                     = $save21413 ?>                  </div>
                </div>
              </div>
              <?php
                }
...
?>              <div class="form-group custom-field custom-field<?php echo @$custom_field["custom_field_id"] ?>" data-sort="<?php echo (@$custom_field["sort_order"] + 3) ?>">
                ...
                <div class="col-sm-10">
                  <div id="input-shipping-custom-field<?php echo @$custom_field["custom_field_id"] ?>">
                    <?php
                    @$save54866 = $custom_field_value                    ;
                    $context['_parent'] = $context;
                    $context['_seq'] = twix_ensure_traversable(@$custom_field["custom_field_value"]);
                    foreach ($context['_seq'] as $_key => $custom_field_value) {
?>                    <div class="checkbox">
                      <?php
                        if ((@$shipping_custom_field[@$custom_field["custom_field_id"]] && twix_in_filter(@$custom_field_value["custom_field_value_id"], @$shipping_custom_field[@$custom_field["custom_field_id"]]))) {
?>                      <label>
                        <input type="checkbox" name="custom_field[<?php echo @$custom_field["custom_field_id"] ?>][]" value="<?php echo @$custom_field_value["custom_field_value_id"] ?>" checked="checked" />
                        <?php echo @$custom_field_value["name"] ?></label>
                      <?php
...
?>                    </div>
                    ...
                    unset($context['_seq'], $context['_iterated'], $context['_key'], $context['custom_field_value'], $context['_parent'], $context['loop']);
                    $context = array_intersect_key($context, $_parent) + $_parent;
$custom_field_value                     = $save54866 ?>                  </div>
                </div>
              </div>
              <?php
                }
...
?>              <div class="form-group custom-field custom-field<?php echo @$custom_field["custom_field_id"] ?>" data-sort="<?php echo (@$custom_field["sort_order"] + 3) ?>">
                <label class="col-sm-2 control-label" for="input-shipping-custom-field<?php echo @$custom_field["custom_field_id"] ?>"><?php echo @$custom_field["name"] ?></label>
                <div class="col-sm-10">
                  <input type="text" name="custom_field[<?php echo @$custom_field["custom_field_id"] ?>]" value="<?php echo ((@$shipping_custom_field[@$custom_field["custom_field_id"]]) ? (@$shipping_custom_field[@$custom_field["custom_field_id"]]) : (@$custom_field["value"])) ?>" placeholder="<?php echo @$custom_field["name"] ?>" id="input-shipping-custom-field<?php echo @$custom_field["custom_field_id"] ?>" class="form-control" />
                </div>
              </div>
              <?php
                }
...
?>              <div class="form-group custom-field custom-field<?php echo @$custom_field["custom_field_id"] ?>" data-sort="<?php echo (@$custom_field["sort_order"] + 3) ?>">
                <label class="col-sm-2 control-label" for="input-shipping-custom-field<?php echo @$custom_field["custom_field_id"] ?>"><?php echo @$custom_field["name"] ?></label>
                <div class="col-sm-10">
                  <textarea name="custom_field[<?php echo @$custom_field["custom_field_id"] ?>]" rows="5" placeholder="<?php echo @$custom_field["name"] ?>" id="input-shipping-custom-field<?php echo @$custom_field["custom_field_id"] ?>" class="form-control"><?php echo ((@$shipping_custom_field[@$custom_field["custom_field_id"]]) ? (@$shipping_custom_field[@$custom_field["custom_field_id"]]) : (@$custom_field["value"])) ?></textarea>
                </div>
              </div>
              <?php
                }
...
?>              <div class="form-group custom-field custom-field<?php echo @$custom_field["custom_field_id"] ?>" data-sort="<?php echo (@$custom_field["sort_order"] + 3) ?>">
                ...
                <div class="col-sm-10">
                  ...
                  <input type="hidden" name="custom_field[<?php echo @$custom_field["custom_field_id"] ?>]" value="<?php echo ((@$shipping_custom_field[@$custom_field["custom_field_id"]]) ? (@$shipping_custom_field[@$custom_field["custom_field_id"]]) : ("")) ?>" id="input-custom-field<?php echo @$custom_field["custom_field_id"] ?>" />
                </div>
              </div>
              <?php
                }
...
?>              <?php
        ...
        unset($context['_seq'], $context['_iterated'], $context['_key'], $context['custom_field'], $context['_parent'], $context['loop']);
        $context = array_intersect_key($context, $_parent) + $_parent;
$custom_field         = $save92626 ?>              <div class="row">
                <div class="col-sm-6 text-left">
...
$('select[name=\'currency\']').on('change', function() {
	$.ajax({
		url: '<?php echo @$catalog ?>index.php?route=api/currency&api_token=<?php echo @$api_token ?>&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
...
$('#button-customer').on('click', function() {
	$.ajax({
		url: '<?php echo @$catalog ?>index.php?route=api/customer&api_token=<?php echo @$api_token ?>&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
		...
		success: function(json) {
			...
			if (json['error']) {
                ...
                var request_1 = $.ajax({
                    url: '<?php echo @$catalog ?>index.php?route=api/cart/add&api_token=<?php echo @$api_token ?>&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
                    type: 'post',
                ...
                var request_2 = request_1.then(function() {
                    $.ajax({
                        url: '<?php echo @$catalog ?>index.php?route=api/voucher/add&api_token=<?php echo @$api_token ?>&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
                        type: 'post',
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['error']) {
				...
				$('input[name=\'amount\']').val('<?php echo twix_escape_filter($this->env, @$voucher_min, "js") ?>');
...
$('#cart').delegate('.btn-danger', 'click', function() {
	...
	$.ajax({
		url: '<?php echo @$catalog ?>index.php?route=api/cart/remove&api_token=<?php echo @$api_token ?>&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
...
$('select[name=\'payment_address\']').on('change', function() {
	$.ajax({
		url: 'index.php?route=customer/customer/address&user_token=<?php echo @$user_token ?>&address_id=' + this.value,
		dataType: 'json',
		beforeSend: function() {
...
$('#button-payment-address').on('click', function() {
	$.ajax({
		url: '<?php echo @$catalog ?>index.php?route=api/payment/address&api_token=<?php echo @$api_token ?>&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
		...
		success: function(json) {
			...
			if (json['error']) {
				...
				// Payment Methods
				$.ajax({
					url: '<?php echo @$catalog ?>index.php?route=api/payment/methods&api_token=<?php echo @$api_token ?>&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
					dataType: 'json',
					crossDomain: true,
					beforeSend: function() {
						$('#button-payment-address').button('loading');
...
$('#button-shipping-address').on('click', function() {
	$.ajax({
		url: '<?php echo @$catalog ?>index.php?route=api/shipping/address&api_token=<?php echo @$api_token ?>&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
		...
		success: function(json) {
			...
			if (json['error']) {
				...
				// Shipping Methods
				var request = $.ajax({
					url: '<?php echo @$catalog ?>index.php?route=api/shipping/methods&api_token=<?php echo @$api_token ?>&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
					dataType: 'json',
					beforeSend: function() {
						$('#button-shipping-address').button('loading');
					},
...
$('#button-shipping-method').on('click', function() {
	$.ajax({
		url: '<?php echo @$catalog ?>index.php?route=api/shipping/method&api_token=<?php echo @$api_token ?>&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
...
$('#button-payment-method').on('click', function() {
	$.ajax({
		url: '<?php echo @$catalog ?>index.php?route=api/payment/method&api_token=<?php echo @$api_token ?>&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
...
$('#button-coupon').on('click', function() {
	$.ajax({
		url: '<?php echo @$catalog ?>index.php?route=api/coupon&api_token=<?php echo @$api_token ?>&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
...
$('#button-voucher').on('click', function() {
	$.ajax({
		url: '<?php echo @$catalog ?>index.php?route=api/voucher&api_token=<?php echo @$api_token ?>&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
...
$('#button-reward').on('click', function() {
	$.ajax({
		url: '<?php echo @$catalog ?>index.php?route=api/reward&api_token=<?php echo @$api_token ?>&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
...
$('input[name=\'affiliate\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=customer/customer/autocomplete&user_token=<?php echo @$user_token ?>&filter_affiliate=1&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {
				json.unshift({
					customer_id: 0,
...
$('#button-save').on('click', function() {
	if ($('input[name=\'order_id\']').val() == 0) {
		var url = '<?php echo @$catalog ?>index.php?route=api/order/add&api_token=<?php echo @$api_token ?>&store_id=' + $('select[name=\'store_id\'] option:selected').val();
	} else {
		var url = '<?php echo @$catalog ?>index.php?route=api/order/edit&api_token=<?php echo @$api_token ?>&store_id=' + $('select[name=\'store_id\'] option:selected').val() + '&order_id=' + $('input[name=\'order_id\']').val();
	}
...
$('#button-refresh').on('click', function() {
	$.ajax({
		url: '<?php echo @$catalog ?>index.php?route=api/cart/products&api_token=<?php echo @$api_token ?>&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		dataType: 'json',
		crossDomain: true,
		beforeSend: function() {
