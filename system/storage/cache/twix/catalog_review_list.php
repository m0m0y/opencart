...
/* Twix ver. 1.18  Source: C:\xampp\htdocs\opencart\admin\view\template\catalog\review_list.twig */
class catalog_review_list extends Twix_Template
{
  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="button" data-toggle="tooltip" title="<?php echo @$button_filter ?>" onclick="$('#filter-review').toggleClass('hidden-sm hidden-xs');" class="btn btn-default hidden-md hidden-lg"><i class="fa fa-filter"></i></button>
...
?>                
      ...
      <div class="col-md-9 col-md-pull-3 col-sm-12">
        ...
        if ((@$sort == "pd.name")) {
?> <a href="<?php echo @$sort_product ?>" class="<?php echo strtolower(@$order) ?>"><?php echo @$column_product ?></a> <?php
        } else {
?> <a href="<?php echo @$sort_product ?>"><?php echo @$column_product ?></a> <?php
        }
?></td>
                      <td class="text-left"><?php
        if ((@$sort == "r.author")) {
?> <a href="<?php echo @$sort_author ?>" class="<?php echo strtolower(@$order) ?>"><?php echo @$column_author ?></a> <?php
        } else {
?> <a href="<?php echo @$sort_author ?>"><?php echo @$column_author ?></a> <?php
        }
?></td>
                      <td class="text-right"><?php
        if ((@$sort == "r.rating")) {
?> <a href="<?php echo @$sort_rating ?>" class="<?php echo strtolower(@$order) ?>"><?php echo @$column_rating ?></a> <?php
        } else {
?> <a href="<?php echo @$sort_rating ?>"><?php echo @$column_rating ?></a> <?php
        }
?></td>
                      <td class="text-left"><?php
        if ((@$sort == "r.status")) {
...
?>                  <tr>
                ...
                if (twix_in_filter(@$review["review_id"], @$selected)) {
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=catalog/review&user_token=<?php echo @$user_token ?>';
