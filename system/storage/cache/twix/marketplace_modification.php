...
/* Twix ver. 1.18  Source: C:\xampp\htdocs\opencart\admin\view\template\marketplace\modification.twig */
class marketplace_modification extends Twix_Template
{
...
?></td>
        ...
        if (@$modifications) {
?>                    <?php
            @$save40177 = $modification            ;
            $context['_parent'] = $context;
            $context['_seq'] = twix_ensure_traversable(@$modifications);
            foreach ($context['_seq'] as $_key => $modification) {
?>                    <tr>
                      <td class="text-center"><?php
                if (twix_in_filter(@$modification["modification_id"], @$selected)) {
