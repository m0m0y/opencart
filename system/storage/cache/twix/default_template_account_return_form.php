...
/* Twix ver. 1.18  Source: C:\xampp\htdocs\opencart\catalog\view\theme\default\template\account\return_form.twig */
class default_template_account_return_form extends Twix_Template
{
...
?> </div>
        ...
        @$save33159 = $return_reason        ;
        $context['_parent'] = $context;
        $context['_seq'] = twix_ensure_traversable(@$return_reasons);
        foreach ($context['_seq'] as $_key => $return_reason) {
?>              <?php
