...
/* Twix ver. 1.18  Source: C:\xampp\htdocs\opencart\admin\view\template\extension\dashboard\chart_info.twig */
class extension_dashboard_chart_info extends Twix_Template
{
...
$('#range a').on('click', function(e) {
	...
	$.ajax({
		type: 'get',
		url: 'index.php?route=extension/dashboard/chart/chart&user_token=<?php echo @$user_token ?>&range=' + $(this).attr('href'),
		dataType: 'json',
