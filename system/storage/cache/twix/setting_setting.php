...
/* Twix ver. 1.18  Source: C:\xampp\htdocs\opencart\admin\view\template\setting\setting.twig */
class setting_setting extends Twix_Template
{
...
?> </div>
        ...
        @$save83760 = $theme        ;
        $context['_parent'] = $context;
        $context['_seq'] = twix_ensure_traversable(@$themes);
        foreach ($context['_seq'] as $_key => $theme) {
?>                    <?php
...
?>                  <div class="checkbox">
                    <label> <?php
                if (twix_in_filter(@$location["location_id"], @$config_location)) {
...
$country         = $save71967 ?>                  
        ...
        @$save68278 = $timezone        ;
        $context['_parent'] = $context;
        $context['_seq'] = twix_ensure_traversable(@$timezones);
        foreach ($context['_seq'] as $_key => $timezone) {
?>                      <?php
...
$customer_group         = $save30502 ?>                    
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10"> <?php
        @$save43797 = $customer_group        ;
        $context['_parent'] = $context;
        $context['_seq'] = twix_ensure_traversable(@$customer_groups);
        foreach ($context['_seq'] as $_key => $customer_group) {
?>                    <div class="checkbox">
                      <label> <?php
            if (twix_in_filter(@$customer_group["customer_group_id"], @$config_customer_group_display)) {
...
$order_status         = $save37699 ?>                    
        ...
        @$save99615 = $order_status        ;
        $context['_parent'] = $context;
        $context['_seq'] = twix_ensure_traversable(@$order_statuses);
        foreach ($context['_seq'] as $_key => $order_status) {
?>                      <div class="checkbox">
                        <label> <?php
            if (twix_in_filter(@$order_status["order_status_id"], @$config_processing_status)) {
...
?> </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <div class="well well-sm" style="height: 150px; overflow: auto;"> <?php
        @$save38228 = $order_status        ;
        $context['_parent'] = $context;
        $context['_seq'] = twix_ensure_traversable(@$order_statuses);
        foreach ($context['_seq'] as $_key => $order_status) {
?>                      <div class="checkbox">
                        <label> <?php
            if (twix_in_filter(@$order_status["order_status_id"], @$config_complete_status)) {
...
?> </label>
              ...
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-affiliate-group"><?php echo @$entry_affiliate_group ?></label>
                  <div class="col-sm-10">
                    <select name="config_affiliate_group_id" id="input-affiliate-group" class="form-control">
                      
                      <?php
        @$save10920 = $customer_group        ;
        $context['_parent'] = $context;
        $context['_seq'] = twix_ensure_traversable(@$customer_groups);
        foreach ($context['_seq'] as $_key => $customer_group) {
?>                      <?php
...
$return_status         = $save96303 ?>                    
        ...
        @$save82683 = $captcha        ;
        $context['_parent'] = $context;
        $context['_seq'] = twix_ensure_traversable(@$captchas);
        foreach ($context['_seq'] as $_key => $captcha) {
?>                      <?php
...
$captcha         = $save82683 ?>                    
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <div class="well well-sm" style="height: 150px; overflow: auto;"> <?php
        @$save82434 = $captcha_page        ;
        $context['_parent'] = $context;
        $context['_seq'] = twix_ensure_traversable(@$captcha_pages);
        foreach ($context['_seq'] as $_key => $captcha_page) {
?>                      <div class="checkbox">
                        <label> <?php
            if (twix_in_filter(@$captcha_page["value"], @$config_captcha_page)) {
...
$captcha_page         = $save82434 ?> </div>
            ...
            <div class="tab-pane" id="tab-mail">
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-mail-engine"><span data-toggle="tooltip" title="<?php echo @$help_mail_engine ?>"><?php echo @$entry_mail_engine ?></span></label>
                  <div class="col-sm-10">
...
?>                    
              ...
              <fieldset>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <div class="well well-sm" style="height: 150px; overflow: auto;"> <?php
        @$save52548 = $mail_alert        ;
        $context['_parent'] = $context;
        $context['_seq'] = twix_ensure_traversable(@$mail_alerts);
        foreach ($context['_seq'] as $_key => $mail_alert) {
?>                      <div class="checkbox">
                        <label> <?php
            if (twix_in_filter(@$mail_alert["value"], @$config_mail_alert)) {
...
?></label>
                ...
                <div class="form-group required">
                  ...
                  <div class="col-sm-10">
                    ...
                    <?php
        if (@$error_log) {
?>                    <div class="text-danger"><?php echo @$error_log ?></div>
                    <?php
        }
?> </div>
                </div>
...
$('select[name=\'config_theme\']').on('change', function() {
	$.ajax({
		url: 'index.php?route=setting/setting/theme&user_token=<?php echo @$user_token ?>&theme=' + this.value,
		dataType: 'html',
		beforeSend: function() {
