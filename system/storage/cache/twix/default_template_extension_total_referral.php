...
class default_template_extension_total_referral extends Twix_Template
{
  ...
  <div class="panel-heading">
    <h4 class="panel-title"><a href="#collapse-referral" class="accordion-toggle" data-toggle="collapse" data-parent="#accordion"><?php echo @$heading_title ?><i class="fa fa-caret-down"></i></a></h4>
  </div>
  <div id="collapse-referral" class="panel-collapse collapse">
    <div class="panel-body">
      <label class="col-sm-2 control-label" for="input-referral"><?php echo @$entry_referral ?></label>
      <div class="input-group">
        <input type="text" name="referral" value="<?php echo @$referral ?>" placeholder="<?php echo @$entry_referral ?>" id="input-referral" class="form-control" />
        <span class="input-group-btn">
        <input type="button" value="Apply Referral" id="button-referral" data-loading-text="<?php echo @$text_loading ?>" class="btn btn-primary" />
        </span></div>
