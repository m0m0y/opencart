...
<?php
        ...
        $context = array_intersect_key($context, $_parent) + $_parent;
$link         = $save90664 ?><script src="view/javascript/common.js" type="text/javascript"></script>
<?php
        @$save63753 = $script        ;
        $context['_parent'] = $context;
...
?>          <li><a href="<?php echo @$store["href"] ?>" target="_blank"><?php echo @$store["name"] ?></a></li>
          <?php
            ...
            $context = array_intersect_key($context, $_parent) + $_parent;
$store             = $save89947 ?>          <li role="separator" class="divider"></li>
