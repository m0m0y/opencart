...
/* Twix ver. 1.18  Source: C:\xampp\htdocs\opencart\admin\view\template\catalog\attribute_form.twig */
class catalog_attribute_form extends Twix_Template
{
...
?>              <div class="input-group"><span class="input-group-addon"><img src="language/<?php echo @$language["code"] ?>/<?php echo @$language["code"] ?>.png" title="<?php echo @$language["name"] ?>" /></span>
                <input type="text" name="attribute_description[<?php echo @$language["language_id"] ?>][name]" value="<?php echo ((@$attribute_description[@$language["language_id"]]) ? (@$attribute_description[@$language["language_id"]]["name"]) : ("")) ?>" placeholder="<?php echo @$entry_name ?>" class="form-control" />
              </div>
              <?php
...
?>                <?php
        ...
        $context = array_intersect_key($context, $_parent) + $_parent;
$attribute_group         = $save88584 ?>              </select>
              <?php
