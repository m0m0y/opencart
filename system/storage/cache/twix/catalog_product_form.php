...
/* Twix ver. 1.18  Source: C:\xampp\htdocs\opencart\admin\view\template\catalog\product_form.twig */
class catalog_product_form extends Twix_Template
{
...
?>                  <div class="tab-pane" id="language<?php echo @$language["language_id"] ?>">
                    <div class="form-group required">
                      ...
                      <div class="col-sm-10">
                        <input type="text" name="product_description[<?php echo @$language["language_id"] ?>][name]" value="<?php echo ((@$product_description[@$language["language_id"]]) ? (@$product_description[@$language["language_id"]]["name"]) : ("")) ?>" placeholder="<?php echo @$entry_name ?>" id="input-name<?php echo @$language["language_id"] ?>" class="form-control"/>
                        <?php
...
?> </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <textarea name="product_description[<?php echo @$language["language_id"] ?>][description]" placeholder="<?php echo @$entry_description ?>" id="input-description<?php echo @$language["language_id"] ?>" data-toggle="summernote" data-lang="<?php echo @$summernote ?>" class="form-control"><?php echo ((@$product_description[@$language["language_id"]]) ? (@$product_description[@$language["language_id"]]["description"]) : ("")) ?></textarea>
                      </div>
                    </div>
                    <div class="form-group required">
                      <label class="col-sm-2 control-label" for="input-meta-title<?php echo @$language["language_id"] ?>"><?php echo @$entry_meta_title ?></label>
                      <div class="col-sm-10">
                        <input type="text" name="product_description[<?php echo @$language["language_id"] ?>][meta_title]" value="<?php echo ((@$product_description[@$language["language_id"]]) ? (@$product_description[@$language["language_id"]]["meta_title"]) : ("")) ?>" placeholder="<?php echo @$entry_meta_title ?>" id="input-meta-title<?php echo @$language["language_id"] ?>" class="form-control"/>
                        <?php
...
?> </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" name="product_description[<?php echo @$language["language_id"] ?>][tag]" value="<?php echo ((@$product_description[@$language["language_id"]]) ? (@$product_description[@$language["language_id"]]["tag"]) : ("")) ?>" placeholder="<?php echo @$entry_tag ?>" id="input-tag<?php echo @$language["language_id"] ?>" class="form-control"/>
                      </div>
                    </div>
                  </div>
                <?php
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="stock_status_id" id="input-stock-status" class="form-control">
                    ...
                    <?php
        @$save30612 = $stock_status        ;
        $context['_parent'] = $context;
        $context['_seq'] = twix_ensure_traversable(@$stock_statuses);
        foreach ($context['_seq'] as $_key => $stock_status) {
?>                      <?php
...
?> </label> <label class="radio-inline"> <?php
        if ( !@$shipping) {
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  <div class="input-group date">
                    <input type="text" name="date_available" value="<?php echo @$date_available ?>" placeholder="<?php echo @$entry_date_available ?>" data-date-format="YYYY-MM-DD" id="input-date-available" class="form-control"/> <span class="input-group-btn">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="weight_class_id" id="input-weight-class" class="form-control">
                    ...
                    <?php
        @$save90926 = $weight_class        ;
        $context['_parent'] = $context;
        $context['_seq'] = twix_ensure_traversable(@$weight_classes);
        foreach ($context['_seq'] as $_key => $weight_class) {
?>                      <?php
...
?>
            ...
            <div class="tab-pane" id="tab-links">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="manufacturer" value="<?php echo @$manufacturer ?>" placeholder="<?php echo @$entry_manufacturer ?>" id="input-manufacturer" class="form-control"/> <input type="hidden" name="manufacturer_id" value="<?php echo @$manufacturer_id ?>"/>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <div id="product-category" class="well well-sm" style="height: 150px; overflow: auto;"> <?php
        @$save27793 = $product_category        ;
        $context['_parent'] = $context;
        $context['_seq'] = twix_ensure_traversable(@$product_categories);
        foreach ($context['_seq'] as $_key => $product_category) {
?>                      <div id="product-category<?php echo @$product_category["category_id"] ?>"><i class="fa fa-minus-circle"></i> <?php echo @$product_category["name"] ?>
        ...
        $context = array_intersect_key($context, $_parent) + $_parent;
$product_category         = $save27793 ?></div>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <div id="product-filter" class="well well-sm" style="height: 150px; overflow: auto;"> <?php
        @$save44498 = $product_filter        ;
        $context['_parent'] = $context;
        $context['_seq'] = twix_ensure_traversable(@$product_filters);
        foreach ($context['_seq'] as $_key => $product_filter) {
...
?>                      <div class="checkbox">
                        <label> <?php
            if (twix_in_filter(@$store["store_id"], @$product_store)) {
...
$store         = $save87736 ?></div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <div id="product-download" class="well well-sm" style="height: 150px; overflow: auto;"> <?php
        @$save42672 = $product_download        ;
        $context['_parent'] = $context;
        $context['_seq'] = twix_ensure_traversable(@$product_downloads);
        foreach ($context['_seq'] as $_key => $product_download) {
?>                      <div id="product-download<?php echo @$product_download["download_id"] ?>"><i class="fa fa-minus-circle"></i> <?php echo @$product_download["name"] ?>
        ...
        $context = array_intersect_key($context, $_parent) + $_parent;
$product_download         = $save42672 ?></div>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <div id="product-related" class="well well-sm" style="height: 150px; overflow: auto;"> <?php
        @$save22075 = $product_related        ;
        $context['_parent'] = $context;
        $context['_seq'] = twix_ensure_traversable(@$product_relateds);
        foreach ($context['_seq'] as $_key => $product_related) {
              ...
              <div class="table-responsive">
                <table id="attribute" class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <?php
        $attribute_row = 0 ?>                    <?php
        @$save89900 = $product_attribute        ;
        $context['_parent'] = $context;
        $context['_seq'] = twix_ensure_traversable(@$product_attributes);
        foreach ($context['_seq'] as $_key => $product_attribute) {
?>                      <tr id="attribute-row<?php echo @$attribute_row ?>">
                        <td class="text-left" style="width: 40%;"><input type="text" name="product_attribute[<?php echo @$attribute_row ?>][name]" value="<?php echo @$product_attribute["name"] ?>" placeholder="<?php echo @$entry_attribute ?>" class="form-control"/> <input type="hidden" name="product_attribute[<?php echo @$attribute_row ?>][attribute_id]" value="<?php echo @$product_attribute["attribute_id"] ?>"/></td>
                        <td class="text-left"><?php
            @$save78259 = $language            ;
            $context['_parent'] = $context;
            $context['_seq'] = twix_ensure_traversable(@$languages);
            foreach ($context['_seq'] as $_key => $language) {
?>                            <div class="input-group"><span class="input-group-addon"><img src="language/<?php echo @$language["code"] ?>/<?php echo @$language["code"] ?>.png" title="<?php echo @$language["name"] ?>"/></span> <textarea name="product_attribute[<?php echo @$attribute_row ?>][product_attribute_description][<?php echo @$language["language_id"] ?>][text]" rows="5" placeholder="<?php echo @$entry_text ?>" class="form-control"><?php echo ((@$product_attribute["product_attribute_description"][@$language["language_id"]]) ? (@$product_attribute["product_attribute_description"][@$language["language_id"]]["text"]) : ("")) ?></textarea>
                            </div>
                          <?php
            }
            $_parent = $context['_parent'];
...
$language             = $save78259 ?></td>
                      ...
                      <?php
            $attribute_row = (@$attribute_row + 1) ?>                    <?php
        }
        $_parent = $context['_parent'];
        unset($context['_seq'], $context['_iterated'], $context['_key'], $context['product_attribute'], $context['_parent'], $context['loop']);
        $context = array_intersect_key($context, $_parent) + $_parent;
$product_attribute         = $save89900 ?>                  </tbody>
              ...
              <div class="row">
                <div class="col-sm-2">
                  <ul class="nav nav-pills nav-stacked" id="option">
                    <?php
        $option_row = 0 ?>                    <?php
        @$save48091 = $product_option        ;
        $context['_parent'] = $context;
        $context['_seq'] = twix_ensure_traversable(@$product_options);
        foreach ($context['_seq'] as $_key => $product_option) {
?>                      <li><a href="#tab-option<?php echo @$option_row ?>" data-toggle="tab"><i class="fa fa-minus-circle" onclick="$('a[href=\'#tab-option<?php echo @$option_row ?>\']').parent().remove(); $('#tab-option<?php echo @$option_row ?>').remove(); $('#option a:first').tab('show');"></i> <?php echo @$product_option["name"] ?></a></li>
                      <?php
            $option_row = (@$option_row + 1) ?>                    <?php
        }
        $_parent = $context['_parent'];
        unset($context['_seq'], $context['_iterated'], $context['_key'], $context['product_option'], $context['_parent'], $context['loop']);
        $context = array_intersect_key($context, $_parent) + $_parent;
$product_option         = $save48091 ?>                    <li>
        ...
        @$save76828 = $product_option        ;
        $context['_parent'] = $context;
        $context['_seq'] = twix_ensure_traversable(@$product_options);
        foreach ($context['_seq'] as $_key => $product_option) {
?>                      <div class="tab-pane" id="tab-option<?php echo @$option_row ?>">
                        <input type="hidden" name="product_option[<?php echo @$option_row ?>][product_option_id]" value="<?php echo @$product_option["product_option_id"] ?>"/> <input type="hidden" name="product_option[<?php echo @$option_row ?>][name]" value="<?php echo @$product_option["name"] ?>"/> <input type="hidden" name="product_option[<?php echo @$option_row ?>][option_id]" value="<?php echo @$product_option["option_id"] ?>"/> <input type="hidden" name="product_option[<?php echo @$option_row ?>][type]" value="<?php echo @$product_option["type"] ?>"/>
                        <div class="form-group">
...
?>                          <div class="form-group">
                            ...
                            <div class="col-sm-3">
                              <div class="input-group date">
                                <input type="text" name="product_option[<?php echo @$option_row ?>][value]" value="<?php echo @$product_option["value"] ?>" placeholder="<?php echo @$entry_option_value ?>" data-date-format="YYYY-MM-DD" id="input-value<?php echo @$option_row ?>" class="form-control"/> <span class="input-group-btn">
                            <button class="btn btn-default" type="button"><i class="fa fa-calendar"></i></button>
                            </span></div>
                            </div>
                          </div>
...
?>                          <div class="form-group">
                            ...
                            <div class="col-sm-10">
                              <div class="input-group time">
                                <input type="text" name="product_option[<?php echo @$option_row ?>][value]" value="<?php echo @$product_option["value"] ?>" placeholder="<?php echo @$entry_option_value ?>" data-date-format="HH:mm" id="input-value<?php echo @$option_row ?>" class="form-control"/> <span class="input-group-btn">
...
?>                          <div class="form-group">
                            ...
                            <div class="col-sm-10">
                              <div class="input-group datetime">
                                <input type="text" name="product_option[<?php echo @$option_row ?>][value]" value="<?php echo @$product_option["value"] ?>" placeholder="<?php echo @$entry_option_value ?>" data-date-format="YYYY-MM-DD HH:mm" id="input-value<?php echo @$option_row ?>" class="form-control"/> <span class="input-group-btn">
                            <button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
                            </span></div>
                            </div>
                          </div>
...
?>                          <div class="table-responsive">
                            <table id="option-value<?php echo @$option_row ?>" class="table table-striped table-bordered table-hover">
                              ...
                              <tbody>
                                ...
                                <?php
                @$save74154 = $product_option_value                ;
                $context['_parent'] = $context;
                $context['_seq'] = twix_ensure_traversable(@$product_option["product_option_value"]);
                foreach ($context['_seq'] as $_key => $product_option_value) {
...
?>
                                          <?php
                        @$save78588 = $option_value                        ;
                        $context['_parent'] = $context;
                        $context['_seq'] = twix_ensure_traversable(@$option_values[@$product_option["option_id"]]);
...
?>
                                      ...
                                      </select> <input type="text" name="product_option[<?php echo @$option_row ?>][product_option_value][<?php echo @$option_value_row ?>][price]" value="<?php echo @$product_option_value["price"] ?>" placeholder="<?php echo @$entry_price ?>" class="form-control"/></td>
...
?>
                                      ...
                                      </select> <input type="text" name="product_option[<?php echo @$option_row ?>][product_option_value][<?php echo @$option_value_row ?>][points]" value="<?php echo @$product_option_value["points"] ?>" placeholder="<?php echo @$entry_points ?>" class="form-control"/></td>
...
?>
                                      ...
                                      </select> <input type="text" name="product_option[<?php echo @$option_row ?>][product_option_value][<?php echo @$option_value_row ?>][weight]" value="<?php echo @$product_option_value["weight"] ?>" placeholder="<?php echo @$entry_weight ?>" class="form-control"/></td>
                                  ...
                                  <?php
                    $option_value_row = (@$option_value_row + 1) ?>                                <?php
                }
                $_parent = $context['_parent'];
                unset($context['_seq'], $context['_iterated'], $context['_key'], $context['product_option_value'], $context['_parent'], $context['loop']);
                $context = array_intersect_key($context, $_parent) + $_parent;
$product_option_value                 = $save74154 ?>                              </tbody>
              ...
              <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <?php
        $recurring_row = 0 ?>                    <?php
        @$save14921 = $product_recurring        ;
        $context['_parent'] = $context;
        $context['_seq'] = twix_ensure_traversable(@$product_recurrings);
        foreach ($context['_seq'] as $_key => $product_recurring) {
...
$customer_group             = $save83655 ?>
                      ...
                      <?php
            $recurring_row = (@$recurring_row + 1) ?>                    <?php
        }
        $_parent = $context['_parent'];
        unset($context['_seq'], $context['_iterated'], $context['_key'], $context['product_recurring'], $context['_parent'], $context['loop']);
        $context = array_intersect_key($context, $_parent) + $_parent;
$product_recurring         = $save14921 ?>                  </tbody>
              ...
              <div class="table-responsive">
                <table id="discount" class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <?php
        $discount_row = 0 ?>                    <?php
        @$save17956 = $product_discount        ;
        $context['_parent'] = $context;
        $context['_seq'] = twix_ensure_traversable(@$product_discounts);
        foreach ($context['_seq'] as $_key => $product_discount) {
?>                      <tr id="discount-row<?php echo @$discount_row ?>">
                        <td class="text-left"><select name="product_discount[<?php echo @$discount_row ?>][customer_group_id]" class="form-control">
                            <?php
            @$save32136 = $customer_group            ;
            $context['_parent'] = $context;
            $context['_seq'] = twix_ensure_traversable(@$customer_groups);
            foreach ($context['_seq'] as $_key => $customer_group) {
?>                              <?php
...
?>                            <?php
            ...
            unset($context['_seq'], $context['_iterated'], $context['_key'], $context['customer_group'], $context['_parent'], $context['loop']);
            $context = array_intersect_key($context, $_parent) + $_parent;
$customer_group             = $save32136 ?>                          </select></td>
                        ...
                        <td class="text-left" style="width: 20%;">
                          <div class="input-group date">
                            <input type="text" name="product_discount[<?php echo @$discount_row ?>][date_start]" value="<?php echo @$product_discount["date_start"] ?>" placeholder="<?php echo @$entry_date_start ?>" data-date-format="YYYY-MM-DD" class="form-control"/> <span class="input-group-btn">
                        <button class="btn btn-default" type="button"><i class="fa fa-calendar"></i></button>
                        </span></div>
                        </td>
                        <td class="text-left" style="width: 20%;">
                          <div class="input-group date">
                            <input type="text" name="product_discount[<?php echo @$discount_row ?>][date_end]" value="<?php echo @$product_discount["date_end"] ?>" placeholder="<?php echo @$entry_date_end ?>" data-date-format="YYYY-MM-DD" class="form-control"/> <span class="input-group-btn">
                        <button class="btn btn-default" type="button"><i class="fa fa-calendar"></i></button>
                        </span></div>
                        </td>
                      ...
                      <?php
            $discount_row = (@$discount_row + 1) ?>                    <?php
        }
        $_parent = $context['_parent'];
        unset($context['_seq'], $context['_iterated'], $context['_key'], $context['product_discount'], $context['_parent'], $context['loop']);
        $context = array_intersect_key($context, $_parent) + $_parent;
$product_discount         = $save17956 ?>                  </tbody>
              ...
              <div class="table-responsive">
                <table id="special" class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <?php
        $special_row = 0 ?>                    <?php
        @$save89768 = $product_special        ;
        $context['_parent'] = $context;
        $context['_seq'] = twix_ensure_traversable(@$product_specials);
        foreach ($context['_seq'] as $_key => $product_special) {
?>                      <tr id="special-row<?php echo @$special_row ?>">
                        <td class="text-left"><select name="product_special[<?php echo @$special_row ?>][customer_group_id]" class="form-control">


                            <?php
            @$save62530 = $customer_group            ;
            $context['_parent'] = $context;
            $context['_seq'] = twix_ensure_traversable(@$customer_groups);
            foreach ($context['_seq'] as $_key => $customer_group) {
?>                              <?php
...
$customer_group             = $save62530 ?>
                        ...
                        <td class="text-left" style="width: 20%;">
                          <div class="input-group date">
                            <input type="text" name="product_special[<?php echo @$special_row ?>][date_start]" value="<?php echo @$product_special["date_start"] ?>" placeholder="<?php echo @$entry_date_start ?>" data-date-format="YYYY-MM-DD" class="form-control"/> <span class="input-group-btn">
                        <button class="btn btn-default" type="button"><i class="fa fa-calendar"></i></button>
                        </span></div>
                        </td>
                        <td class="text-left" style="width: 20%;">
                          <div class="input-group date">
                            <input type="text" name="product_special[<?php echo @$special_row ?>][date_end]" value="<?php echo @$product_special["date_end"] ?>" placeholder="<?php echo @$entry_date_end ?>" data-date-format="YYYY-MM-DD" class="form-control"/> <span class="input-group-btn">
                        <button class="btn btn-default" type="button"><i class="fa fa-calendar"></i></button>
                        </span></div>
                        </td>
                      ...
                      <?php
            $special_row = (@$special_row + 1) ?>                    <?php
        }
        $_parent = $context['_parent'];
        unset($context['_seq'], $context['_iterated'], $context['_key'], $context['product_special'], $context['_parent'], $context['loop']);
        $context = array_intersect_key($context, $_parent) + $_parent;
$product_special         = $save89768 ?>                  </tbody>
              ...
              <div class="table-responsive">
                <table id="images" class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <?php
        $image_row = 0 ?>                    <?php
        @$save86890 = $product_image        ;
        $context['_parent'] = $context;
        $context['_seq'] = twix_ensure_traversable(@$product_images);
        foreach ($context['_seq'] as $_key => $product_image) {
?>                      <tr id="image-row<?php echo @$image_row ?>">
                      ...
                      <?php
            $image_row = (@$image_row + 1) ?>                    <?php
        }
        $_parent = $context['_parent'];
        unset($context['_seq'], $context['_iterated'], $context['_key'], $context['product_image'], $context['_parent'], $context['loop']);
        $context = array_intersect_key($context, $_parent) + $_parent;
$product_image         = $save86890 ?>                  </tbody>
              ...
              <div class="table-responsive">
                <table class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <?php
        @$save78244 = $customer_group        ;
        $context['_parent'] = $context;
        $context['_seq'] = twix_ensure_traversable(@$customer_groups);
        foreach ($context['_seq'] as $_key => $customer_group) {
?>                      <tr>
                        <td class="text-left"><?php echo @$customer_group["name"] ?></td>
                        <td class="text-right"><input type="text" name="product_reward[<?php echo @$customer_group["customer_group_id"] ?>][points]" value="<?php echo ((@$product_reward[@$customer_group["customer_group_id"]]) ? (@$product_reward[@$customer_group["customer_group_id"]]["points"]) : ("")) ?>" class="form-control"/></td>
                      </tr>
                    <?php
        }
        $_parent = $context['_parent'];
        unset($context['_seq'], $context['_iterated'], $context['_key'], $context['customer_group'], $context['_parent'], $context['loop']);
        $context = array_intersect_key($context, $_parent) + $_parent;
$customer_group         = $save78244 ?>                  </tbody>
...
?>                      <tr>
            ...
            $context['_seq'] = twix_ensure_traversable(@$languages);
            foreach ($context['_seq'] as $_key => $language) {
?>                            <div class="input-group"><span class="input-group-addon"><img src="language/<?php echo @$language["code"] ?>/<?php echo @$language["code"] ?>.png" title="<?php echo @$language["name"] ?>"/></span> <input type="text" name="product_seo_url[<?php echo @$store["store_id"] ?>][<?php echo @$language["language_id"] ?>]" value="<?php
                if (@$product_seo_url[@$store["store_id"]][@$language["language_id"]]) {
echo @$product_seo_url[@$store["store_id"]][@$language["language_id"]];
                }
...
?>                              <?php
                if ((@$product_layout[@$store["store_id"]] && (@$product_layout[@$store["store_id"]] == @$layout["layout_id"]))) {
?>
...
$language         = $save47034 ?>	  html += '  </td>';
  ...
  function addDiscount() {
    ...
    <?php
        @$save54573 = $customer_group        ;
        $context['_parent'] = $context;
        $context['_seq'] = twix_ensure_traversable(@$customer_groups);
        foreach ($context['_seq'] as $_key => $customer_group) {
?>	  html += '    <option value="<?php echo @$customer_group["customer_group_id"] ?>"><?php echo twix_escape_filter($this->env, @$customer_group["name"], "js") ?></option>';
    <?php
        }
        $_parent = $context['_parent'];
        unset($context['_seq'], $context['_iterated'], $context['_key'], $context['customer_group'], $context['_parent'], $context['loop']);
        $context = array_intersect_key($context, $_parent) + $_parent;
$customer_group         = $save54573 ?>	  html += '  </select></td>';
...
?>	  html += '      <option value="<?php echo @$customer_group["customer_group_id"] ?>"><?php echo twix_escape_filter($this->env, @$customer_group["name"], "js") ?></option>';
    <?php
        ...
        unset($context['_seq'], $context['_iterated'], $context['_key'], $context['customer_group'], $context['_parent'], $context['loop']);
        $context = array_intersect_key($context, $_parent) + $_parent;
$customer_group         = $save85785 ?>	  html += '  </select></td>';
...
?>	  html += '      <option value="<?php echo @$recurring["recurring_id"] ?>"><?php echo @$recurring["name"] ?></option>';
    <?php
        ...
        unset($context['_seq'], $context['_iterated'], $context['_key'], $context['recurring'], $context['_parent'], $context['loop']);
        $context = array_intersect_key($context, $_parent) + $_parent;
$recurring         = $save22099 ?>	  html += '    </select>';
	  html += '  </td>';
	  html += '  <td class="left">';
	  html += '    <select name="product_recurring[' + recurring_row + '][customer_group_id]" class="form-control">>';
    <?php
        @$save15542 = $customer_group        ;
        $context['_parent'] = $context;
        $context['_seq'] = twix_ensure_traversable(@$customer_groups);
        foreach ($context['_seq'] as $_key => $customer_group) {
?>	  html += '      <option value="<?php echo @$customer_group["customer_group_id"] ?>"><?php echo @$customer_group["name"] ?></option>';
    <?php
        ...
        unset($context['_seq'], $context['_iterated'], $context['_key'], $context['customer_group'], $context['_parent'], $context['loop']);
        $context = array_intersect_key($context, $_parent) + $_parent;
$customer_group         = $save15542 ?>	  html += '    <select>';
	  html += '  </td>';
	  html += '  <td class="left">';
