...
class Twix_Environment
{
    ...
    public function loadTemplate($name, $index = null)
    {
        ...
        $cls = str_replace('/', '_', str_replace('.twig', '', $name)); //MaxD2
        ...
        if (!class_exists($cls, false)) {
            ...
            if (!class_exists($cls, false)) {
                ...
                $content = str_replace('twix_join_filter(', 'join(', $content);
...
class Twix_Node_Embed extends Twix_Node_Include
{
    ...
    public function __construct($filename, $index, Twix_Node_Expression $variables = null, $only = false, $ignoreMissing = false, $lineno, $tag = null)
    {
...
{
    public function __construct(Twix_NodeInterface $name, $asString = false, $lineno, $tag = null)
    {
